classdef GraphicalOutput < handle
    ...
    %%% Keep this in mind, do not start all over again if you want code to
    %%% be fast, just use hadles or its equivalents
    ...
    properties(Access = protected)
        ...
        waypointMarkers; %%% these are the purple markers, cool
        waypointRoutes; %%% purple line
        ...
        % Estimates
        xEst; %%% I am guessing these are the solutions  
        PEst; %%% these draw the covariance circles
        estimatedLandmarks; %%% Question 3 landmarks
        PEstimatedLandmarks;  %%% their covs
    ...
    methods(Access = public)
        ...
        function this = GraphicalOutput()
            ...
            %%% loool, B parameter is the vehicle size.
