classdef Simulator < minislam.event_generators.EventGenerator
    ...
    properties(Access = protected)
        ...
        scenarioDirectory; %%% Not sure what this is
    ...
    methods(Access = public)
        ...
        function this = Simulator(parameters, scenarioDirectory)
            ...
            %%% Just gonna conclude that this generates a set of events
            % Setup default
            if (nargin == 1)
                this.scenarioDirectory = 'task12'; %%% for task 1 and 2 I am guessing
            else
                this.scenarioDirectory = scenarioDirectory; %%% For task 3 and above
            end
